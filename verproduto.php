...
<body>
    <div class="formulario">
        <form action="verproduto.php" class="visualizaproduto" method="post" enctype="multipart/form-data">
            ...
            <label>PREÇO</label>
            <input type="number" name="preco" id="preco" value="R$ <?=$preco?>" readonly>
            <button type="submit" id="btn">ADICIONAR AO CARRINHO </button>
        </form>
    </div>
    <div class="favoritos">
        <a href="favoritar.php?id=<? $id ?>">
            <img src="<?php echo $coracao; ?>" width="50" height="50"/></a>
            <td><img src="data:image/jpeg;base64,<?= $imagem_atual?>" name="imagem_atual" class="imagem_atual"></td>
    </div>
</body>
</html>